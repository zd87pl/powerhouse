    ...
    <div className="min-h-screen bg-[#09090b] text-zinc-100 overflow-hidden">
      ...
      <section className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 pt-24 pb-16 sm:pt-32 sm:pb-20 text-center">
        <div className="inline-flex items-center gap-2 rounded-full border border-indigo-500/20 bg-indigo-500/5 px-4 py-1.5 text-sm text-indigo-300 mb-8">
          ...
          Open source &middot; BYOK &middot; Self-hosted
        </div>
        ...
        <p className="mt-6 text-lg sm:text-xl text-zinc-400 max-w-2xl mx-auto leading-relaxed">
          ...
          code, and deploys to production &mdash; all on your own infrastructure
          with your own keys.
        </p>
        ...
        <p className="mt-3 text-xs text-zinc-600">
          No terminal required. Demo runs instantly &mdash; no keys needed.
        </p>
      </section>
      ...
      {/* Bottom CTA */}
      <section className="relative z-10 max-w-2xl mx-auto px-4 sm:px-6 pb-24 text-center">
        <div className="rounded-2xl border border-indigo-500/10 bg-indigo-500/[0.02] p-10">
          <h2 className="text-2xl font-bold mb-4">Ready to build?</h2>
          <p className="text-zinc-400 mb-6 max-w-md mx-auto">
            Open source. Bring your own keys. Deploy in minutes.
          </p>
          <Link
            href={`${DASHBOARD_URL}/setup`}
            className="inline-flex items-center gap-2 rounded-xl bg-indigo-500 px-8 py-4 text-base font-semibold text-white hover:bg-indigo-400 transition-all shadow-lg shadow-indigo-500/25"
          >
            Get Started Free
      ...
      <footer className="relative z-10 border-t border-white/[0.04] py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-zinc-600">
          <div className="flex items-center gap-2">
            ...
            <span>Instill &mdash; Autonomous AI Engineering</span>
          </div>
